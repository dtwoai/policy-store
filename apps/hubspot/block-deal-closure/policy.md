...
description: |
  ...
  **Package:** `hubspot.ingress.no_close_deal`
  ...
  - **SOC 2 CC6.3** — role-based access and segregation of duties: moving a deal
    into a closed stage stays a human decision; the agent channel cannot
    consummate the close.
